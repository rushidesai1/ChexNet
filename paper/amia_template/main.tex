...
\begin{figure}[h!]
\centering
\includegraphics[scale=1]{amia_template/pics/model_loss_3.png}
\caption{Model loss}
\label{fig1}
\end{figure}
...
\begin{figure}[h!]
\centering
\includegraphics[scale=1]{amia_template/pics/model_accuracy_3.png}
...
\begin{figure}[h!]
\centering
\includegraphics[scale=1]{amia_template/pics/CNN-Performance.png}
\caption{Model Accuracy}
\label{fig2}
\end{figure}
...
\begin{figure}[h!]
\centering
\includegraphics[scale=1]{amia_template/pics/Resnet-Performance.png}
\caption{Model Accuracy}
\label{fig2}
\end{figure}
