...
Using only ChestXray14, better performance was achieved by using stochastic gradient descent with momentum instead of the Adam optimizer. This was found to generalize better[reference] and provide better results on the test set. Other improvements to the performance would be utilizing deeper versions of the Densenet model such as Densenet169, and Densenet201. Utilizing these models in an ensemble pattern would also provide benefits to the overall performance.
