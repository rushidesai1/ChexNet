...
The details of each of these activites are covered in subsequent sections.
...
AUC score is used to determine performance of the model, and will be compared against previous results obtained by other papers.
